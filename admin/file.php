                        ...
                        <div class="hero-unit-3">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;Таблиця матеріалів</strong>
                                </div>
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    <td width="50">
                                        <a rel="tooltip"  title="Видалити файл" id="d<?php echo $file_id; ?>" href="#course_id<?php echo $file_id; ?>" role="button"  data-toggle="modal" class="btn btn-danger"><i class="icon-trash icon-large"></i></a>
                                    ...
                                    <div id="course_id<?php echo $file_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="delete_file.php<?php echo '?id=' . $file_id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Видалити</a>
                                        </div>
                                    </div>
                                    <!-- end delete modal -->
