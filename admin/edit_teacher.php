                        ...
                        <div class="hero-unit-3">
                            ...
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="Ім'я користувача" value="<?php echo $row['username']; ?>" required>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputPassword">Пароль</label>
                                    <div class="controls">
                                        <input type="text" name="Пароль" id="inputPassword" value="<?php echo $row['password']; ?>" required>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">Ім'я</label>
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="Ім'я" value="<?php echo $row['firstname']; ?>" required>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">Прізвище</label>
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="Прізвище" value="<?php echo $row['lastname']; ?>" required>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label" for="inputEmail">По батькові</label>
                                    <div class="controls">
                                        <input type="text" id="inputEmail" name="По батькові" value="<?php echo $row['middlename'] ?>" required>
                                    </div>
                                </div>
								<div class="control-group">
