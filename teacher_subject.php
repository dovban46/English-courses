    ...
    <div class="container">
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <li   class="active"><a href="teacher_subject.php"><i class="icon-file-alt icon-large"></i>&nbsp;Предмет
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
            ...
            <div class="span9">
                ...
                <a href="teacher_add_subject.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Додати предмет</a>
                <br>
                <br>
                <div class="hero-unit-3">
                        ...
                        <tbody>
                            ...
                            <div id="id<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="delete_teacher_course.php<?php echo '?id=' . $course_id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Видалити</a>
                                </div>
                            </div>
                            <!-- end delete modal -->
