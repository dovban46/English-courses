...
<body>
    ...
    <div class="container">
        <div class="row-fluid">
            <div class="span3">
                ...
                <div class="hero-unit-1">
                    <ul class="nav  nav-pills nav-stacked">
                        ...
                        <li  class="active"><a href="teacher_subject.php"><i class="icon-file-alt icon-large"></i>&nbsp;Предмети
                                <div class="pull-right">
                                    <i class="icon-double-angle-right icon-large"></i>
                                </div>  
                            </a></li>
            ...
            <div class="span9">
                <a href="teacher_subject.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Назад</a>
                <br>
                <br>

                <div class="alert alert-info">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong><i class="icon-user icon-large"></i>&nbsp;Додати тему</strong>
                </div>
                <div class="hero-unit-2">
                    <form class="form-horizontal" method="POST">
                        <div class="control-group">
                            <label class="control-label" for="inputEmail">Предмети</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button type="submit" name="save_subject" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Додати предмет</button>
                            </div>
                            <br>
                            <?php
                            if (isset($_POST['save_subject'])) {
                                ...
                                if ($count > 0) {
                                    ?>
                                    <div class="alert alert-danger">Предмет <strong>Вже існує</strong></div>
                                    <?php
                                } else {
