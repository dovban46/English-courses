    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span9">
                ...
                <a href="teacher_class.php" class="btn btn-success"><i class="icon-arrow-left icon-large"></i>&nbsp;Назад</a>
                <br>
                <br>

                <div class="alert alert-info">
                    <button type="button" class="close" data-dismiss="alert">&times;</button>
                    <strong><i class="icon-user icon-large"></i>&nbsp;Додати клас</strong>
                </div>
                <div class="hero-unit-2">
                    <form class="form-horizontal" method="POST">
                        <div class="control-group">
                            <label class="control-label" for="inputEmail">Клас</label>
                            <div class="controls">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <button type="submit" name="save_class" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Додати клас</button>
                            </div>
                            <?php
