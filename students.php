    ...
    <div class="container">
        <div class="row-fluid">
            ...
            <div class="span9">
                ...
                <a href="teacher_add_student.php" class="btn btn-success"><i class="icon-plus-sign icon-large"></i>&nbsp;Додати студента</a>
                <br>
                <br>
                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        <tbody>
                            ...
                            <td><?php echo $student_row['lastname'] . " " . $student_row['firstname'] . " " . $student_row['middle_name']; ?></td>
                            ...
                            <div id="teacher<?php echo $student_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <a href="delete_teacher_students.php<?php echo '?id=' . $student_id; ?>" class="btn btn-danger"><i class="icon-trash icon-large"></i>&nbsp;Видалити</a>
                                </div>
                            </div>
                            <!-- end delete modal -->
                            ...
                            <div id="view<?php echo $student_id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <div class="modal-body">
                                    <div class="alert alert-info">Студент <strong>Інформація</strong></div>
                                    <div class="span12">
                                        <div class="span6">
                                            <p>  Ім'я:&nbsp;<strong><?php echo $student_row['lastname'] . " " . $student_row['firstname'] . " " . $student_row['middle_name']  ; ?></strong> </p>
                                        </div>
                                        <div class="span6">
