                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        <div class="alert alert-info">
                            ...
                            <strong><i class="icon-user icon-large"></i>&nbsp;Мій клас</strong>
                        </div>
                        <thead>
                            <tr>
                                <th>Клас</th>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($query)) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><a rel="tooltip"  title="Переглянути" id="v<?php echo $class_id; ?>"  href="class_student.php<?php echo '?id=' . $class_id; ?>" class="btn btn-info">&nbsp;<i class="icon-file-alt icon-large"></i>&nbsp;<?php echo $row['subject_id']; ?></a></td>
